...
namespace mylittle_project.infrastructure.Migrations
{
    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DealerSubscriptionApplications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DealerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealerSubscriptionApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealerSubscriptionApplications_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealerSubscriptionApplications_Dealers_DealerId",
                        column: x => x.DealerId,
                        principalTable: "Dealers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealerSubscriptionApplications_Dealers_DealerId1",
                        column: x => x.DealerId1,
                        principalTable: "Dealers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DealerSubscriptionApplications_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealerSubscriptionApplications_CategoryId",
                table: "DealerSubscriptionApplications",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerSubscriptionApplications_DealerId",
                table: "DealerSubscriptionApplications",
                column: "DealerId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerSubscriptionApplications_DealerId1",
                table: "DealerSubscriptionApplications",
                column: "DealerId1");

            migrationBuilder.CreateIndex(
                name: "IX_DealerSubscriptionApplications_TenantId",
                table: "DealerSubscriptionApplications",
                column: "TenantId");
